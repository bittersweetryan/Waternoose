...
<form action="index.cfm" method="post">
	<ul>
		...
		<input type="text"  name="longname" value="#opportunity.getlongname()#"></li>
		<li><label for="shortname">Short Name</label> 
		<input type="text"  name="shortname" value="#opportunity.getshortname()#"></li>
		<li><label for="description">Opportunity Description</label> 
		<input type="text"  name="description" value="#opportunity.getdescription()#"></li>
		<li><label for="duration">Opportunity Duration</label> 
		<input type="text"  name="duration" value="#opportunity.getduration()#"></li>
		<li><label for="opendate">Open Date</label> 
		<input type="text"  name="opendate" value="#opportunity.getopendate()#"></li>
		<li><label for="closedate">Close Date</label> 
		<input type="text"  name="closedate" value="#opportunity.getclosedate()#"></li>
		<li><label for="numberneeded">Number of Volunteers Needed</label> 
		<input type="text"  name="numberneeded" value="#opportunity.getnumberneeded()#"></li>
	</ul>
